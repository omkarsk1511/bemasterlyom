...
public class deletmtutor {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Thread.sleep(1000);
		driver.findElement(By.cssSelector("em[class='icon ni ni-more-h'")).click();
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("em[class='icon ni ni-trash'")).click();
		Thread.sleep(1000);
