...
public class activeMhcetTemplate {
	...
	public static void main(String[] args) throws InterruptedException {
		ChromeOptions opt = new ChromeOptions(); 
		  ...
		  driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
			String examName = "activeMhcetTemplate";
			
				driver.get("https://Prodtest57.bemasterly.com/");
				driver.manage().window().maximize();
				driver.findElement(By.id("username")).sendKeys("prodtest57");
				driver.findElement(By.id("password")).sendKeys("prodtest57");
